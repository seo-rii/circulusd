...
func TestPlannerBuildsExplicitFailClosedProductionPlan(t *testing.T) {
	...
	required := []string{
		...
		"arg: \"--backend\"",
		"arg: \"nsjail\"",
		"arg: \"--execution-environment-digest\"",
		"arg: \"sha256:eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee\"",
		"arg: \"--protocol-version\"",
		"arg: \"1\"",
		"arg: \"--command-manifest-owner-uid\"",
		"arg: \"65534\"",
...
func TestPlannerRejectsUntrustedPathsDowngradesAndUnboundedResources(t *testing.T) {
	...
	configTests := []struct {
		...
		{name: "zero command manifest owner uid", mutate: func(config *Config) { config.CommandManifestOwnerUID = 0 }},
		{name: "command manifest owner uid sentinel", mutate: func(config *Config) { config.CommandManifestOwnerUID = math.MaxUint32 }},
	}
	...
	requestTests := []struct {
		...
		{name: "bad execution environment digest", mutate: func(request *Request) { request.EnvironmentDigest = "sha256:ABC" }},
