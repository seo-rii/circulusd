/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: ee7f8697aa84ddc2728f4df3f8e4b4bb)
// Runtime types generated with workerd@1.20260825.1 2026-08-01 
interface __BaseEnv_Env {
	SESSION_CELL: DurableObjectNamespace<import("./src/host/worker").SessionCell>;
	WORKSPACE_CELL: DurableObjectNamespace<import("./src/host/worker").WorkspaceCell>;
	USER_CELL: DurableObjectNamespace<import("./src/host/worker").UserCell>;
	EXTENSION_STATE_CELL: DurableObjectNamespace<import("./src/host/worker").ExtensionStateCell>;
	CAPABILITY_GENERATION_CELL: DurableObjectNamespace<import("./src/host/worker").CapabilityGenerationCell>;
	AUDIT_CELL: DurableObjectNamespace<import("./src/host/worker").AuditCell>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/host/worker");
		durableNamespaces: "SessionCell" | "WorkspaceCell" | "UserCell" | "ExtensionStateCell" | "CapabilityGenerationCell" | "AuditCell";
	}
